...
provider :facebook, '250050248346256','9735ae616f47b11f109748800d05f877', {:scope => "user_about_me,user_online_presence,user_photos,user_status,read_stream,publish_stream,offline_access"}
end